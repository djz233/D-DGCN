...
from code.problems.pd.pd_model import TrigNet
from code.problems.pd.pd_problem import PDProblem
...
class ExperimentUtils:
    ...
    def build_problem(self):
        ...
        if problem_class_name == "PD":
            problem_class = PDProblem
    ...
    def load_trained_model(self, gpu_number):
        ...
        '''
            ...
            if self.configuration["task"]["problem_class"] == "PD":
